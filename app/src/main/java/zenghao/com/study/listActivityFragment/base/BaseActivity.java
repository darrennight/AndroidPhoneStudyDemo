 ...
 *
 * @author zenghao
 * @since 2017/7/6 下午8:29
 */
public abstract class BaseActivity extends AppCompatActivity implements Toolbar.OnMenuItemClickListener{

    protected Toolbar mToolbar;
    protected TextView mTitleBarTxt;
    ...
    protected void setUpToolbar(int titleResId, int menuId, int mode) {
        if (mode != MODE_NONE) {
            ...
            mToolbar.setTitle("");
            mTitleBarTxt = (TextView) findViewById(R.id.toolbar_title);
    ...
    protected void setUpTitle(int titleResId) {
        if (titleResId > 0 && mTitleBarTxt != null) {
            mTitleBarTxt.setText(titleResId);
        }
    }
