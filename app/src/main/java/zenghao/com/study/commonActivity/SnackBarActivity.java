...
import zenghao.com.study.view.snackbarBuild.CafeBar;
import zenghao.com.study.view.snackbarBuild.CafeBarCallback;
import zenghao.com.study.view.snackbarBuild.CafeBarDuration;
import zenghao.com.study.view.snackbarBuild.CafeBarGravity;
import zenghao.com.study.view.snackbarBuild.CafeBarTheme;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.simple_single_line).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CafeBar.make(SnackBarActivity.this, "Single Line...", CafeBarDuration.SHORT).show();
            }
        });
        ...
        findViewById(R.id.simple_multi_lines).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                CafeBar.make(SnackBarActivity.this, R.string.demo_text, CafeBarDuration.SHORT).show();
            }
        });
        ...
        findViewById(R.id.simple_themed).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                CafeBar.builder(SnackBarActivity.this)
        ...
        findViewById(R.id.simple_action).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                CafeBar cafeBar = CafeBar.make(SnackBarActivity.this, "CafeBar with Action", CafeBarDuration.INDEFINITE);
                cafeBar.setAction("Action", Color.parseColor("#03A9F4"), new CafeBarCallback() {
                    @Override
                    public void OnClick(@NonNull CafeBar cafeBar) {
                        Toast.makeText(SnackBarActivity.this, "CafeBar dismissed", Toast.LENGTH_LONG).show();
        ...
        findViewById(R.id.themed_custom_background_color).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                CafeBar.Builder builder = new CafeBar.Builder(SnackBarActivity.this)
                        .content(R.string.demo_text)
                        .duration(2000);
            ...
            public void onClick(View view) {
                CafeBar.builder(SnackBarActivity.this)
                        ...
                        .onPositive(new CafeBarCallback() {
                            @Override
                            public void OnClick(@NonNull CafeBar cafeBar) {
                                Toast.makeText(SnackBarActivity.this, "Positive pressed", Toast.LENGTH_SHORT).show();
                        ...
                        .onNegative(new CafeBarCallback() {
                            @Override
                            public void OnClick(@NonNull CafeBar cafeBar) {
                                Toast.makeText(SnackBarActivity.this, "Negative pressed", Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View view) {
                CafeBar.builder(SnackBarActivity.this)
                        ...
                        .onNeutral(new CafeBarCallback() {
                            @Override
                            public void OnClick(@NonNull CafeBar cafeBar) {
                                Toast.makeText(SnackBarActivity.this, "Neutral pressed", Toast.LENGTH_SHORT).show();
        ...
        findViewById(R.id.activity_trasnlucent_navbar).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //startActivity(new Intent(SnackBarActivity.this, TranslucentNavBarActivity.class));
            }
        });
    }
}