...
public abstract class PermissionsResultAction {
     ...
     */
    public abstract void onGranted(List<String> denieds);
     ...
     */
    public abstract void onDenied(boolean isLast,String permission);
    ...
    protected synchronized final boolean onResult(final @NonNull String permission, Permissions result) {
        ...
        if (result == Permissions.GRANTED) {
            if (mPermissions.isEmpty()) {
                new Handler(mLooper).post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        list.addAll(mDeniedPermissions);
                        onGranted(list);
            ...
            new Handler(mLooper).post(new Runnable() {
                @Override
                public void run() {
                    onDenied(mPermissions.isEmpty(),permission);
                }
            });
            return true;
