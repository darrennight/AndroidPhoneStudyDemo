...
import zenghao.com.study.PullFresh.method1.RotationFooter;
import zenghao.com.study.PullFresh.method1.RotationHeader;
...
public class Demo2Activity extends AppCompatActivity { 
    ...
    private class AdapterForList extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            TextView item_text;
            if(convertView == null){
                convertView = LayoutInflater.from(context).inflate(R.layout.item_pull_fresh, parent, false);
