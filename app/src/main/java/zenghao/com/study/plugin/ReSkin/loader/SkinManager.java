...
import zenghao.com.study.plugin.ReSkin.listener.ILoaderListener;
import zenghao.com.study.plugin.ReSkin.listener.ISkinLoader;
...
public class SkinManager implements ISkinLoader {
     ...
     * </p>
     *
     * @param skinName the name of skin(in assets/skin)  皮肤名字
     * @param callback load Callback 回调
     */
