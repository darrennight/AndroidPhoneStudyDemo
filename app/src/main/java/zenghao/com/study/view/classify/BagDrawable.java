...
class BagDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        if (keepShow || inMerge) {
            ...
            mPaint.setShader(new RadialGradient(mRectF.centerX(), mRectF.centerY(), mRectF.width(),
                    mCenterColor, mEdgeColor, Shader.TileMode.CLAMP));
    ...
    private Property<BagDrawable, Integer> mOutlineProperty =
            new Property<BagDrawable, Integer>(Integer.class, "outline") {
                @Override
