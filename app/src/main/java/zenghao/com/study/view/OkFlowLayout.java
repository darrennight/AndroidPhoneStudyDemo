 ...
 * @since 17/4/5 下午6:49
 */
public class OkFlowLayout extends ViewGroup {
    ...
    public OkFlowLayout(Context context) {
        this(context, null);
    }

    public OkFlowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OkFlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs,
                R.styleable.OkFlowLayout);
        lineSpacing = mTypedArray.getDimensionPixelSize(
                R.styleable.OkFlowLayout_lineSpacing, 0);
        mTypedArray.recycle();
    }
