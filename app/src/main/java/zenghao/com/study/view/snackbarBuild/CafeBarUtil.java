...
class CafeBarUtil {
    ...
    static Snackbar getBaseSnackBar(@NonNull View cafeBarLayout,
        ...
        Snackbar snackBar = Snackbar.make(view, "", builder.autoDismiss() ? builder.duration() : Snackbar.LENGTH_INDEFINITE);
        ...
        try {
            if (snackBarLayout.getLayoutParams() instanceof CoordinatorLayout.LayoutParams) {
                CoordinatorLayout.LayoutParams snackBarParams = (CoordinatorLayout.LayoutParams)snackBarLayout.getLayoutParams();
                ...
                FrameLayout.LayoutParams snackBarParams = (FrameLayout.LayoutParams)snackBarLayout.getLayoutParams();
                snackBarParams.width = ViewGroup.LayoutParams.MATCH_PARENT;
                snackBarLayout.setLayoutParams(snackBarParams);
            }else{
                Snackbar.SnackbarLayout.LayoutParams snackBarParams = (Snackbar.SnackbarLayout.LayoutParams)snackBarLayout.getLayoutParams();
                snackBarParams.width = ViewGroup.LayoutParams.MATCH_PARENT;
                snackBarLayout.setLayoutParams(snackBarParams);
            }
        } catch (ClassCastException e) {
