package zenghao.com.study.VHRecyleView2;
 ...
 *
 * @author zenghao
 * @since 16/10/8 下午5:11
 * https://github.com/rubensousa/RecyclerViewSnap
 */
public class VHListUIActivity extends AppCompatActivity implements Toolbar.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vhlist);
